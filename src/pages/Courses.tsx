...
const levels = [
  {
    ...
    lessons: [
      ...
      { title: "Марковские процессы принятия решений (MDP)", type: "lesson", path: "/courses/1-3" },
      { title: "Q-Learning: табличный метод", type: "lesson", path: "/courses/1-4" },
      { title: "CartPole — твой первый RL-агент", type: "lesson", path: "/courses/1-5" },
      { title: "DQN с нуля на PyTorch", type: "lesson", path: "/courses/1-6" },
