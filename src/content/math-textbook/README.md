...
- **Наружу, в код** — привязка к двенадцати средам `unity/MLAgentsLab/Assets/Envs/E00`–`E11` лаборатории и к ядру обучения `python/labrl`, сводка в [`_meta/unity-bridge.md`](_meta/unity-bridge.md).
